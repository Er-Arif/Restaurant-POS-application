...
class RestaurantSettings(TimestampMixin, Base):
    ...
    receipt_header: Mapped[str] = mapped_column(String(160), default="Thank you for dining with us!", nullable=False)
    receipt_subheader: Mapped[str] = mapped_column(String(160), default="", nullable=False)
    receipt_footer: Mapped[str] = mapped_column(Text, default="Visit again soon!", nullable=False)
    receipt_show_address: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    receipt_show_phone: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    receipt_show_gst: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    receipt_show_cashier: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    receipt_show_table: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    receipt_show_order_number: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
